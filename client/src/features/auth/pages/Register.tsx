      ...
      <div className="relative z-10 w-full bg-[#0C0E14]/80 border border-primary/20 rounded-2xl p-5 md:p-7 lg:p-6 xl:p-7 shadow-[0_0_50px_rgba(255,51,102,0.12)] backdrop-blur-xl space-y-4 md:space-y-5">
        ...
        <div className="flex flex-col items-center text-center space-y-2.5">
          ...
          <div className="flex items-center gap-2 select-none">
            <svg className="h-5 w-5 text-primary filter drop-shadow-[0_0_8px_var(--color-primary)]" viewBox="0 0 24 24" fill="currentColor">
              <rect x="3" y="3" width="7" height="7" rx="1.5" />
              <rect x="14" y="3" width="7" height="7" rx="1.5" />
              <rect x="3" y="14" width="7" height="7" rx="1.5" />
              <rect x="14" y="14" width="7" height="7" rx="1.5" className="text-white" />
            </svg>
            <span className="font-extrabold tracking-tight text-lg font-outfit text-white">
              Career<span className="text-primary font-bold">Twin</span>
            </span>
          </div>

          <div className="space-y-0.5">
            <h1 className="text-xl md:text-2xl font-extrabold tracking-tight text-white font-outfit">
              Create your account
            </h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
          ...
          <Button 
            type="submit" 
            className="w-full py-4 mt-1 rounded-xl bg-gradient-to-r from-primary to-[#FF3366] hover:from-primary/95 hover:to-[#FF3366]/95 text-white font-bold shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-all duration-300 transform active:scale-[0.99] text-sm" 
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button
              type="button"
              variant="outline"
              className="w-full py-3 rounded-xl flex items-center justify-center gap-2 border-border/40 hover:bg-muted/40 hover:border-primary/30 text-xs font-semibold transition-all duration-200"
            >
